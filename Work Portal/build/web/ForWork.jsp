<%-- 
    Document   : ForWork
    Created on : 9 Nov, 2019, 8:53:18 PM
    Author     : lenovo
--%>
...
<html>
    <head>
     ...
     <body>
        <%
            String num=request.getParameter("Phone_N");
             Class.forName("com.mysql.jdbc.Driver");
        Connection con=DriverManager.getConnection("jdbc:mysql://localhost/raunak","root","Rakesh");
        PreparedStatement ps=con.prepareStatement("select Create_P from RegWork where Phone_N=?");
        ps.setString(1, num);
